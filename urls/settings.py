...
SECRET_KEY = 'django-insecure-xi8mtgi9r*ty!h%3z(fv6sj%dzovu0kfya)rvmmf%7kh70pj98'
...
STATIC_ROOT = os.environ.get('STATIC_ROOT', '/home/uby/public_html/static')
MEDIA_URL = '/media/'
MEDIA_ROOT = '/home/uby/public_html/media'
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', get_secret('EMAIL_NOTIFY'))
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', get_secret('EMAIL_PASSWORD')')
